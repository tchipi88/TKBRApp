(function() {
    ...
    AccessGroupDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'DataUtils', 'entity', 'AccessGroup'];

    function AccessGroupDialogController ($timeout, $scope, $stateParams, $uibModalInstance, DataUtils, entity, AccessGroup ) {
        var vm = this;
