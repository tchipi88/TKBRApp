(function() {
    ...
    TerrainDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', '$uibModal','DataUtils', 'entity', 'Terrain','Unite','ProduitCategorie'];

    function TerrainDialogController ($timeout, $scope, $stateParams, $uibModalInstance,$uibModal, DataUtils, entity, Terrain ,Unite,ProduitCategorie) {
        var vm = this;
