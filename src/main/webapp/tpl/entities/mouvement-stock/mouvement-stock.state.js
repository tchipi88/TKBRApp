    ...
    function stateConfig($stateProvider) {
        ...
        .state('mouvement-stock', {
            ...
            data: {
                ...
                pageTitle: 'tkbrApp.mouvementStock.home.title'
            },
            views: {
                'content@': {
                    templateUrl: 'app/entities/mouvement-stock/mouvement-stocks.html',
            ...
            resolve: {
                ...
                translatePartialLoader: ['$translate', '$translatePartialLoader', function ($translate, $translatePartialLoader) {
                    $translatePartialLoader.addPart('mouvementStock');
        ...
        .state('mouvement-stock-detail', {
            ...
            data: {
                authorities: ['ROLE_USER'],
                pageTitle: 'tkbrApp.mouvementStock.detail.title'
            },
            views: {
                'content@': {
                    templateUrl: 'app/entities/mouvement-stock/mouvement-stock-detail.html',
        ...
        .state('mouvement-stock-detail.edit', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/mouvement-stock/mouvement-stock-dialog.html',
        ...
        .state('mouvement-stock.delete', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/mouvement-stock/mouvement-stock-delete-dialog.html',
