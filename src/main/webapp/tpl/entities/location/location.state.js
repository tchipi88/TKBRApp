    ...
    function stateConfig($stateProvider) {
        $stateProvider
                .state('location', {
                    ...
                    views: {
                        'content@app': {
                            templateUrl: 'tpl/entities/location/locations.html',
                ...
                .state('location-detail', {
                    ...
                    views: {
                        'content@app': {
                            templateUrl: 'tpl/entities/location/location-detail.html',
                ...
                .state('location-detail.edit', {
                    ...
                    onEnter: ['$stateParams', '$state', '$uibModal', function ($stateParams, $state, $uibModal) {
                            $uibModal.open({
                                templateUrl: 'tpl/entities/location/location-dialog.html',
                ...
                .state('location.delete', {
                    ...
                    onEnter: ['$stateParams', '$state', '$uibModal', function ($stateParams, $state, $uibModal) {
                            $uibModal.open({
                                templateUrl: 'tpl/entities/location/location-delete-dialog.html',
