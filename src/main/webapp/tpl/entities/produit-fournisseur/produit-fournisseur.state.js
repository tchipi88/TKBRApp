    ...
    function stateConfig($stateProvider) {
        ...
        .state('produit-fournisseur', {
            ...
            data: {
                ...
                pageTitle: 'tkbrApp.produitFournisseur.home.title'
            },
            views: {
                'content@': {
                    templateUrl: 'app/entities/produit-fournisseur/produit-fournisseurs.html',
            ...
            resolve: {
                ...
                translatePartialLoader: ['$translate', '$translatePartialLoader', function ($translate, $translatePartialLoader) {
                    $translatePartialLoader.addPart('produitFournisseur');
        ...
        .state('produit-fournisseur-detail', {
            ...
            data: {
                authorities: ['ROLE_USER'],
                pageTitle: 'tkbrApp.produitFournisseur.detail.title'
            },
            views: {
                'content@': {
                    templateUrl: 'app/entities/produit-fournisseur/produit-fournisseur-detail.html',
        ...
        .state('produit-fournisseur-detail.edit', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/produit-fournisseur/produit-fournisseur-dialog.html',
        ...
        .state('produit-fournisseur.delete', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/produit-fournisseur/produit-fournisseur-delete-dialog.html',
