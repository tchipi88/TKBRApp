...
public class CompteAnalytiqueResource {
   ...
   /**
    ...
    @Timed
    public ResponseEntity<List<CompteAnalytique>> getAllCompteAnalytiques(@ApiParam Pageable pageable,@ApiParam  CompteAnalytiqueType  type) {
        log.debug("REST request to get all CompteAnalytiques");
        Page<CompteAnalytique> page = compteAnalytiqueRepository.findByType(pageable,type);
