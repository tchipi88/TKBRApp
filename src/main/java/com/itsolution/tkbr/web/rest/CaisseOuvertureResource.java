...
import com.itsolution.tkbr.domain.CaisseOuverture;

import com.itsolution.tkbr.repository.CaisseOuvertureRepository;
...
public class CaisseOuvertureResource {
    ...
    @Timed
    public ResponseEntity<CaisseOuverture> createCaisseOuverture(@Valid @RequestBody CaisseOuverture caisseOuverture) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<CaisseOuverture> updateCaisseOuverture(@Valid @RequestBody CaisseOuverture caisseOuverture) throws URISyntaxException {
