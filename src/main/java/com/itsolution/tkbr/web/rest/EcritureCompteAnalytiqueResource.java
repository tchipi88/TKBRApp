...
public class EcritureCompteAnalytiqueResource {
    ...
    @Timed
    public ResponseEntity<EcritureCompteAnalytique> createEcritureCompteAnalytique(@Valid @RequestBody EcritureCompteAnalytique ecritureCompteAnalytique) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<EcritureCompteAnalytique> updateEcritureCompteAnalytique(@Valid @RequestBody EcritureCompteAnalytique ecritureCompteAnalytique) throws URISyntaxException {
