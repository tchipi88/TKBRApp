...
//        authoritySearchRepository.delete(id);
...
//    @Timed
//    public List<Authority> searchAuthoritys(@RequestParam String query) {
//        log.debug("REST request to search Authoritys for query {}", query);
