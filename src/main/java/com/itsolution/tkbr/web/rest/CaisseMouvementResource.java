...
import com.itsolution.tkbr.domain.CaisseMouvement;

import com.itsolution.tkbr.repository.CaisseMouvementRepository;
...
public class CaisseMouvementResource {
    ...
    @Timed
    public ResponseEntity<CaisseMouvement> createCaisseMouvement(@Valid @RequestBody CaisseMouvement caisseMouvement) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<CaisseMouvement> updateCaisseMouvement(@Valid @RequestBody CaisseMouvement caisseMouvement) throws URISyntaxException {
