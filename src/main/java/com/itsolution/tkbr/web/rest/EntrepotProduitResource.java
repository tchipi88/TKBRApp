...
public class EntrepotProduitResource {
    ...
    @Timed
    public ResponseEntity<EntrepotProduit> createEntrepotProduit(@Valid @RequestBody EntrepotProduit entrepotProduit) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<EntrepotProduit> updateEntrepotProduit(@Valid @RequestBody EntrepotProduit entrepotProduit) throws URISyntaxException {
